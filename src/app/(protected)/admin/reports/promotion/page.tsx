  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Promotion Report</h1>
          <p className="text-sm text-muted-foreground">Analysis of items sold through promotional offers</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-blue-600"><CountUp end={stats.avgDiscount} suffix="%" decimals={1} /></div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
        ...
        <Card className={stats.totalProfit >= 0 ? 'border-green-200 bg-green-50/30' : 'border-red-200 bg-red-50/30'}>
          <CardContent className="p-4">
            ...
            <div className={`text-2xl font-bold ${stats.totalProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}>
              <CountUp end={Math.abs(stats.totalProfit)} prefix={stats.totalProfit < 0 ? '-₹' : '₹'} />
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {promotionItems.slice(0, 50).map((item, idx) => (
