    ...
    <div className="space-y-4 md:space-y-6 pb-24">
      ...
      <div className="flex items-center gap-3">
        <Link href={backUrl} className="relative group shrink-0">
          <div className="p-2.5 rounded-lg bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-md group-hover:shadow-lg transition-shadow">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Festival Report</h1>
          <p className="text-sm text-muted-foreground">Analysis of items sold during festival sales</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold"><CountUp end={stats.totalItems} /></div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-green-600"><CountUp end={stats.avgSavings} prefix="₹" /></div>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-green-600"><CountUp end={stats.totalRevenue} prefix="₹" /></div>
          </CardContent>
        </Card>
        <Card className={stats.totalViolations > 0 ? 'border-red-200 bg-red-50/30' : 'border-green-200 bg-green-50/30'}>
          <CardContent className="p-4">
            ...
            <div className={`text-2xl font-bold ${stats.totalViolations > 0 ? 'text-red-600' : 'text-green-600'}`}>
              <CountUp end={stats.totalViolations} />
            </div>
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {festivalItems.slice(0, 50).map((item, idx) => (
                    <tr key={item.id} className={`border-b hover:bg-muted/30 animate-stagger-fade-in ${item.has_violation ? 'bg-red-50/50' : ''}`} style={{ '--row-index': idx } as React.CSSProperties}>
