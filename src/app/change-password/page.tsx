...
export default function ChangePasswordPage() {
  ...
  const { errors, validateFields, clearFieldError } = useFormErrors<'currentPassword' | 'newPassword' | 'confirmPassword'>();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newPwErr = !newPassword ? 'Please enter a new password'
      : newPassword.length < 8 ? 'Must be at least 8 characters'
      : newPassword === currentPassword ? 'Must be different from current password'
      : passwordStrength < 3 ? 'Please choose a stronger password'
      : undefined;

    const valid = validateFields({
      currentPassword: [!currentPassword, 'Please enter your temporary password'],
      newPassword: [!!newPwErr, newPwErr || ''],
      ...
      <Card className="w-full max-w-md shadow-2xl relative z-10 backdrop-blur-sm bg-white/95">
        <CardHeader className="space-y-3 text-center">
          ...
          <div className="flex justify-center mb-2">
            <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${a.gradientLight} flex items-center justify-center shadow-lg`}>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 ${fieldErrorClass(errors.currentPassword)}`}
                  disabled={loading}
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 ${fieldErrorClass(errors.newPassword)}`}
                  disabled={loading}
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 ${fieldErrorClass(errors.confirmPassword)}`}
                  disabled={loading}
                />
                <button
                  type="button"
          ...
          <CardFooter>
            <Button
              type="submit"
              className={`w-full ${s.primaryGradient} ${s.primaryGradientHover}`}
              disabled={loading}
            >
              {loading ? (
