...
export default function StaffPage() {
  ...
  const loadStaff = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .eq('role', 'staff') // Only show staff accounts, not admin/owner/superadmin
  ...
  const handleAddStaff = () => {
    toast.info(
      'New staff members must register their account via the login page first. After they register, you can edit their role and permissions here.',
      { duration: 6000 }
    );
  };
