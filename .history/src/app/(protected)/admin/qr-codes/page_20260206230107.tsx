...
import { QrCode as QrCodeIcon, Plus, Download, Search, ArrowLeft, Trash2, RefreshCw, ChevronFirst, ChevronLast, ChevronLeft, ChevronRight, Eye, Printer, Tags } from 'lucide-react';
...
export default function QrCodesPage() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      {/* Stats - 2x2 mobile, 5 columns desktop */}
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
        <Card
          className={`hover:shadow-lg transition-all cursor-pointer ${filterStatus === 'all' ? 'ring-2 ring-teal-500 shadow-md' : ''}`}
        ...
        <Card
          className={`hover:shadow-lg transition-all cursor-pointer ${filterStatus === 'unused' ? 'ring-2 ring-green-500 shadow-md' : ''}`}
        ...
        <Card
          className={`hover:shadow-lg transition-all cursor-pointer ${filterStatus === 'assigned' ? 'ring-2 ring-blue-500 shadow-md' : ''}`}
        ...
        <Card
          className={`hover:shadow-lg transition-all cursor-pointer ${filterStatus === 'sold' ? 'ring-2 ring-purple-500 shadow-md' : ''}`}
        ...
        <Card
          className={`hover:shadow-lg transition-all cursor-pointer ${filterStatus === 'lost' ? 'ring-2 ring-red-500 shadow-md' : ''}`}
          onClick={() => setFilterStatus('lost')}
        >
          <CardHeader className="pb-2 pt-4 px-4">
            <CardDescription className="text-xs">Lost</CardDescription>
            <CardTitle className="text-2xl text-red-500">{stats.lost}</CardTitle>
          </CardHeader>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="space-y-4">
            ...
            {/* Status Tabs */}
            <Tabs value={filterStatus} onValueChange={(v) => { setFilterStatus(v as QrStatus | 'all'); setCurrentPage(1); }}>
