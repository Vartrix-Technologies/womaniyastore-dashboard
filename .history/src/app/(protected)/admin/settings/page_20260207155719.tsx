        ...
        {shop && shopId && (
          <>
            <TabsContent value="shop">
              <ShopDetailsTab shopId={shopId} shop={shop} onRefresh={loadData} />
            </TabsContent>

            <TabsContent value="tax">
              <TaxSettingsTab shopId={shopId} shop={shop} onRefresh={loadData} />
            </TabsContent>

            <TabsContent value="categories">
              <CategoriesTab shopId={shopId} categories={categories} onRefresh={loadData} />
            </TabsContent>

            <TabsContent value="sizes">
              <SizesTab shopId={shopId} sizes={sizes} onRefresh={loadData} />
            </TabsContent>

            <TabsContent value="expense-categories">
              <ExpenseCategoriesTab shopId={shopId} expenseCategories={expenseCategories} onRefresh={loadData} />
            </TabsContent>

            <TabsContent value="qr-prefixes">
              <QrPrefixesTab shopId={shopId} qrPrefixes={qrPrefixes} onRefresh={loadData} />
            </TabsContent>
          </>
        )}
      </Tabs>
