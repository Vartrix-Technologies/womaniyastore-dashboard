...
export default function SettingsPage() {
  ...
  const handleDeleteQrPrefix = async (id: string) => {
    if (!confirm('Are you sure you want to delete this QR prefix? This will fail if any QR codes are assigned.')) return;
