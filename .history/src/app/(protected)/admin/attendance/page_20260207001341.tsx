...
import { Users, Clock, Edit, Trash2, Plus, ArrowLeft, Search, ChevronLeft, ChevronRight, ChevronFirst, ChevronLast, RefreshCw, ClipboardList, UserCheck, AlertCircle } from 'lucide-react';
                    ...
                    {logs.length === 0 && !tableLoading ? (
                      ...
                      logs.map((log) => (
                        <tr key={log.id} className="border-b hover:bg-muted/50 transition-colors">
                          ...
                          <td className="p-2">{log.clock_in ? formatTime(log.clock_in) : '-'}</td>
                          <td className="p-2">
                            {log.clock_out ? (
