      ...
      <div className="container-boxed">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3">
            <div className={`w-9 h-9 rounded-lg bg-gradient-to-br ${getLogoGradientClasses()} flex items-center justify-center shadow-sm`}>
              <span className="text-white text-lg font-bold">{appConfig.brand.logoLetter}</span>
            </div>
            <div>
              <h1 className="text-base font-bold leading-tight">{appConfig.brand.name}</h1>
