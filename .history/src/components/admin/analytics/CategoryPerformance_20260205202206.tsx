        ...
        <Card className="border-amber-200 bg-gradient-to-br from-amber-50/50 to-transparent">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Top Performing Category</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  {topCategory.itemsSold} items sold • {topCategory.percentageOfTotal.toFixed(1)}% of revenue
                </div>
              </div>
              <div className="text-right">
                <div className="text-2xl font-bold text-green-600">{formatCurrency(topCategory.revenue)}</div>
                <div className="text-sm text-muted-foreground">
